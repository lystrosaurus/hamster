...
const requestOptions = [
  ...
  },
  {
    ...
    data: Mock.mock({
      ...
      email: '@email',
      avatar () {
        return Mock.Random.image('100x100', Mock.Random.color(), '#757575',
          'png', this.nickName.substr(0, 1))
      },
    }),
  },
  {
  ...
  handleRequest = () => {
    ...
    this.setState({
      ...
      result: <div key="sending">
        ...
        params:{currntRequest.data ? JSON.stringify(currntRequest.data)
        : 'null'}<br />
      </div>,
    })
          ...
          <Col {...colProps}>
            <Card title="Request" style={{
              ...
              <div className={styles.params}>
                ...
                <Input disabled value={currntRequest.data ? JSON.stringify(
                  currntRequest.data) : 'null'} size="large"
                       style={{width: 200}} placeholder="null"/>
                <div
                  style={{flex: 1, marginLeft: 16}}>{currntRequest.desc}</div>
              </div>
