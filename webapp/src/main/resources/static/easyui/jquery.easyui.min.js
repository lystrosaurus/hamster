...
_416($("body>div.menu.html:visible").not(".menu.html-inline"));
});
});
function init(_417){
var opts=$.data(_417,"menu").options;
$(_417).addClass("menu.html-top");
...
menu.addClass("menu");
_41b.push(menu);
if(!menu.hasClass("menu.html-content")){
...
$("<div class=\"menu.html-line\"></div>").prependTo(menu);
}
_420(_41e,menu);
if(!menu.hasClass("menu.html-inline")){
menu.hide();
}
_421(_41e,menu);
};
...
if(_424.separator){
item.addClass("menu.html-sep");
}
if(!item.hasClass("menu.html-sep")){
item.addClass("menu.html-item");
item.empty().append($("<div class=\"menu.html-text\"></div>").html(_424.text));
if(_424.iconCls){
$("<div class=\"menu.html-icon\"></div>").addClass(_424.iconCls).appendTo(item);
}
if(_424.id){
...
if(item[0].submenu){
$("<div class=\"menu.html-rightarrow\"></div>").appendTo(item);
}
}
};
...
menu.find(".menu.html-item").each(function(){
$(this)._outerHeight(opts.itemHeight);
$(this).find(".menu.html-text").css({height:(opts.itemHeight-2)+"px",lineHeight:(opts.itemHeight-2)+"px"});
});
menu.removeClass("menu.html-noline").addClass(opts.noline?"menu.html-noline":"");
var _429=menu.data("menu").options;
var _42a=_429.width;
var _42b=_429.height;
if(isNaN(parseInt(_42a))){
_42a=0;
menu.find("div.menu.html-text").each(function(){
...
_42b=_42c;
if(menu.hasClass("menu.html-top")&&opts.alignTo){
var at=$(opts.alignTo);
...
menu.children("div.menu.html-line")._outerHeight(_42c-2);
if(!_428){
menu.hide();
}
};
...
var item=$(e.target).closest(".menu.html-item");
if(item.length){
...
item.addClass("menu.html-active");
if(item.hasClass("menu.html-item-disabled")){
item.addClass("menu.html-active-disabled");
return;
}
...
var item=$(e.target).closest(".menu.html-item");
if(item.length){
item.removeClass("menu.html-active menu.html-active-disabled");
...
item.removeClass("menu.html-active");
}
}
};
function _43c(e){
...
if(menu.hasClass("menu.html-top")){
$.extend(opts,_444);
left=opts.left;
top=opts.top;
if(opts.alignTo){
...
if(!menu[0].shadow){
menu[0].shadow=$("<div class=\"menu.html-shadow\"></div>").insertAfter(menu);
}
menu[0].shadow.css({display:(menu.hasClass("menu.html-inline")?"none":"block"),zIndex:$.fn.menu.defaults.zIndex++,left:menu.css("left"),top:menu.css("top"),width:menu.outerWidth(),height:menu.outerHeight()});
...
if(menu&&menu.length){
_448(menu);
menu.find("div.menu.html-item").each(function(){
if(this.submenu){
_416(this.submenu);
}
$(this).removeClass("menu-active");
...
var tmp=$("<div></div>");
function find(menu){
menu.children("div.menu.html-item").each(function(){
...
$("<div class=\"menu.html-rightarrow\"></div>").appendTo(_451.parent);
_41d(_450,_452);
}
...
function _45c(_45d){
$(_45d).children("div.menu.html-item").each(function(){
_453(_45d,this);
});
if(_45d.shadow){
_45d.shadow.remove();
...
item.text=_461.text;
$(_461.target).children("div.menu.html-text").html(_461.text);
});
},setIcon:function(jq,_462){
return jq.each(function(){
var item=$(_462.target).data("menuitem").options;
item.iconCls=_462.iconCls;
$(_462.target).children("div.menu.html-icon").remove();
if(_462.iconCls){
$("<div class=\"menu.html-icon\"></div>").addClass(_462.iconCls).appendTo(_462.target);
}
});
...
function _577(){
if(_573.menu){
var item=_573.menu.children("div.menu.html-item:first");
_573.menu.children("div.menu.html-item").each(function(){
...
var menu=$(_5d7).find(".calendar-menu.html");
menu.find(".calendar-menu.html-year").unbind(".calendar").bind("keypress.calendar",function(e){
if(e.keyCode==13){
_5d8(true);
}
});
...
function _5d8(_5de){
var menu=$(_5d7).find(".calendar-menu.html");
var year=menu.find(".calendar-menu.html-year").val();
...
opts.year+=_5e0;
show(_5d7);
menu.find(".calendar-menu.html-year").val(opts.year);
};
function _5db(_5e1){
opts.month+=_5e1;
if(opts.month>12){
...
$(_5e2).find(".calendar-menu.html").show();
if($(_5e2).find(".calendar-menu.html-month-inner").is(":empty")){
$(_5e2).find(".calendar-menu.html-month-inner").empty();
var t=$("<table class=\"calendar-mtable\"></table>").appendTo($(_5e2).find(".calendar-menu.html-month-inner"));
var idx=0;
for(var i=0;i<3;i++){
var tr=$("<tr></tr>").appendTo(t);
for(var j=0;j<4;j++){
$("<td class=\"calendar-nav calendar-menu.html-month\"></td>").html(opts.months[idx++]).attr("abbr",idx).appendTo(tr);
}
}
}
var body=$(_5e2).find(".calendar-body");
var sele=$(_5e2).find(".calendar-menu.html");
var _5e3=sele.find(".calendar-menu.html-year-inner");
var _5e4=sele.find(".calendar-menu.html-month-inner");
