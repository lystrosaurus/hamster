...
var m=$(e.target).closest("div.menu.html,div.combo-p");
if(m.length){
return;
}
$("body>div.menu.html-top:visible").not(".menu.html-inline").menu("hide");
_1($("body>div.menu.html:visible").not(".menu.html-inline"));
});
});
function _2(_3){
var _4=$.data(_3,"menu").options;
$(_3).addClass("menu.html-top");
...
_8.addClass("menu");
_9.push(_8);
if(!_8.hasClass("menu.html-content")){
...
if(!_e.hasClass("menu.html-content")){
_e.children("div").each(function(){
_f(_c,this);
});
$("<div class=\"menu.html-line\"></div>").prependTo(_e);
}
_10(_c,_e);
if(!_e.hasClass("menu.html-inline")){
_e.hide();
}
_11(_c,_e);
};
...
if(_15.separator){
_14.addClass("menu.html-sep");
}
if(!_14.hasClass("menu.html-sep")){
_14.addClass("menu.html-item");
_14.empty().append($("<div class=\"menu.html-text\"></div>").html(_15.text));
if(_15.iconCls){
$("<div class=\"menu.html-icon\"></div>").addClass(_15.iconCls).appendTo(_14);
}
if(_15.id){
_14.attr("id",_15.id);
}
...
if(_14[0].submenu){
$("<div class=\"menu.html-rightarrow\"></div>").appendTo(_14);
}
}
};
...
_18.find(".menu.html-item").each(function(){
$(this)._outerHeight(_19.itemHeight);
$(this).find(".menu.html-text").css({height:(_19.itemHeight-2)+"px",lineHeight:(_19.itemHeight-2)+"px"});
});
_18.removeClass("menu.html-noline").addClass(_19.noline?"menu.html-noline":"");
var _1c=_18.data("menu").options;
var _1d=_1c.width;
var _1e=_1c.height;
if(isNaN(parseInt(_1d))){
_1d=0;
_18.find("div.menu.html-text").each(function(){
...
_1e=_1f;
if(_18.hasClass("menu.html-top")&&_19.alignTo){
var at=$(_19.alignTo);
...
_18.children("div.menu.html-line")._outerHeight(_1f-2);
if(!_1b){
_18.hide();
}
};
...
var _2e=$(e.target).closest(".menu.html-item");
if(_2e.length){
...
_2e.addClass("menu.html-active");
if(_2e.hasClass("menu.html-item-disabled")){
_2e.addClass("menu.html-active-disabled");
return;
}
...
function _30(e){
var _31=$(e.target).closest(".menu.html-item");
if(_31.length){
_31.removeClass("menu.html-active menu.html-active-disabled");
var _32=_31[0].submenu;
if(_32){
if(e.pageX>=parseInt(_32.css("left"))){
_31.addClass("menu.html-active");
}else{
_1(_32);
}
}else{
_31.removeClass("menu.html-active");
}
}
};
function _33(e){
var _34=e.data.target;
var _35=$(e.target).closest(".menu.html-item");
if(_35.length){
...
_40.show(0,function(){
if(!_40[0].shadow){
_40[0].shadow=$("<div class=\"menu.html-shadow\"></div>").insertAfter(_40);
}
_40[0].shadow.css({display:(_40.hasClass("menu.html-inline")?"none":"block"),zIndex:$.fn.menu.defaults.zIndex++,left:_40.css("left"),top:_40.css("top"),width:_40.outerWidth(),height:_40.outerHeight()});
...
if(_44&&_44.length){
_45(_44);
_44.find("div.menu.html-item").each(function(){
if(this.submenu){
_1(this.submenu);
}
$(this).removeClass("menu-active");
...
var tmp=$("<div></div>");
function _4a(_4b){
_4b.children("div.menu.html-item").each(function(){
...
var t=$(_4e);
if(t.hasClass("menu.html-item")){
var _50=t.data("menuitem").options;
_50.disabled=_4f;
if(_4f){
t.addClass("menu.html-item-disabled");
t[0].onclick=null;
}else{
t.removeClass("menu.html-item-disabled");
...
$("<div class=\"menu.html-rightarrow\"></div>").appendTo(_53.parent);
_b(_52,_56);
}
...
function _5a(el){
if(el.submenu){
el.submenu.children("div.menu.html-item").each(function(){
_5a(this);
});
...
function _61(_62){
$(_62).children("div.menu.html-item").each(function(){
_57(_62,this);
});
if(_62.shadow){
_62.shadow.remove();
...
_67.text=_66.text;
$(_66.target).children("div.menu.html-text").html(_66.text);
});
},setIcon:function(jq,_68){
return jq.each(function(){
var _69=$(_68.target).data("menuitem").options;
_69.iconCls=_68.iconCls;
$(_68.target).children("div.menu.html-icon").remove();
if(_68.iconCls){
$("<div class=\"menu.html-icon\"></div>").addClass(_68.iconCls).appendTo(_68.target);
}
});
